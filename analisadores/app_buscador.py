...
# --- INICIALIZAÇÃO DOS BLOQUEIOS DE LEITURA (GATEKEEPERS) ---
if 'leu_busca' not in st.session_state: st.session_state.leu_busca = False
if 'leu_temas' not in st.session_state: st.session_state.leu_temas = False
if 'leu_freq' not in st.session_state: st.session_state.leu_freq = False
...
# ==============================================================================
with tab_busca:
    if not st.session_state.leu_busca:
        ...
        with col_miolo:
            ...
            if corpus_completo:
                ...
                # 3. A SUA LÓGICA ORIGINAL COMEÇA AQUI!
...
# ==============================================================================
with tab_temas:
    if not st.session_state.leu_temas:
        st.info("### 🛑 Notas Metodológicas: Temas\n"
                "Para a análise temática, o sistema atribui um **Peso do Debate** baseado na densidade do assunto em cada reunião:\n"
...
# ==============================================================================
with tab_frequencia:
    if not st.session_state.leu_freq:
        st.warning("### 🛑 Notas Metodológicas: Frequência\n"
                   "* O site utiliza como fonte primária as atas de reuniões e os registros de mandatos publicados no Diário Oficial da Cidade.\n"
        ...
        if st.button("✅ Li e compreendi a metodologia de assiduidade", key="btn_freq"):
